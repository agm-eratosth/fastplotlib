...
---------------------------------------
    ...
    We want `fastplotlib` to be easy to learn and use. To get started with the library we recommend taking a look at our `guide <https://fastplotlib.org/ver/dev/user_guide/guide.html>`_ and
    `examples gallery <https://fastplotlib.org/ver/dev/_gallery/index.html>`_.
